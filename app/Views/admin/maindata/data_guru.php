...
<?=$this->section('content')?>
  ...
  <main id="main" class="main">
    ...
    <a href="#tambahGuru" data-bs-toggle="modal" data-bs-target="#tambahGuru"class="btn btn-primary">
    <i class="bi bi-plus"></i> Tambah Guru</a>
    </div>
...
<!-- Tambah Modal -->
<div class="modal fade" id="tambahGuru" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
